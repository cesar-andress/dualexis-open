...
TSGG reference implementation positions human oversight as a \textbf{formal governance framework for high-risk
...
$\hat{P}(s' \mid s,\sigma)$ from $N=1000$ balanced-profile decisions.
...
\begin{itemize}[noitemsep]
  \item $\gamma_{\mathrm{comp}}$ (\texttt{governance\_compliance\_score}) $=0.435$
        --- policy-aligned terminal states;
  \item \textbf{institutional\_reliance\_index} $=0.465$
        --- appropriate escalation when required;
  \item \textbf{human\_override\_resilience} $=0.103$
